...
class GcCollageView extends
  ...
  public render(): JSX.Element {
    const {open, TransitionComponent, classes, onClose, info} = this.props;
    return (
      <Dialog
        classes={{
          paper: classes.root,
  ...
  private shareClick = () => {
    ...
    if (info && this.ref) {
      const shareSub = onShare({
        date: info.date,
        image: this.ref.toDataURL('image/jpeg'),
